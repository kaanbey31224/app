...
exports.run = function(client, message) {
 ...
 if (!pinkcodeetiketlenenkisi) return message.channel.send("**Lütfen Yumruk Atmak İçin Birini Etiketleyin**")
  
   const pinkcodeembed = new Discord.MessageEmbed()
   
    .setDescription( `${pinkcodeetiketlenenkisi}` +`**${message.author.username}  Sana Yumruk Attı**`)
